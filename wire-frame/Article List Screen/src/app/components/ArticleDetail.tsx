  ...
  return (
    <article className="bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        {/* カテゴリー */}
        <div className="mb-4">
          <span className="inline-block px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm text-blue-600 bg-blue-50 rounded-full">
            {article.category}
          </span>
        </div>
        ...
        {/* メタ情報 */}
        <div className="flex flex-wrap items-center gap-4 sm:gap-6 text-sm sm:text-base text-gray-600 mb-6 sm:mb-8 pb-6 sm:pb-8 border-b border-gray-200">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center flex-wrap gap-2">
            ...
            {article.tags.map((tag) => (
              <a
                key={tag}
                href="#"
                className="px-3 py-1.5 text-xs sm:text-sm text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors touch-manipulation"
              >
                #{tag}
              </a>
            ))}
        ...
        {/* 著者情報 */}
        <div className="mb-8 sm:mb-12 p-4 sm:p-6 bg-gray-50 rounded-xl">
